          ...
          <>
            ...
            <div className="space-y-3">
              ...
              <button
                ...
                className="flex w-full items-center justify-center rounded-lg bg-[#5B50BD] px-4 py-3.5 text-base font-medium text-white transition-colors hover:bg-[#4A41A0] disabled:opacity-50"
              >
          ...
          <>
            ...
            <div className="space-y-3">
              ...
              <div className="text-center">
                <button className="text-sm text-[#5B50BD] hover:text-[#4A41A0]">
                  Forgot password?
                </button>
              </div>
            </div>
