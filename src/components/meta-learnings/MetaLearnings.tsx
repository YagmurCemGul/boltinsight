              ...
              <Card>
                ...
                <CardContent>
                  <div className="space-y-3">
                    <StatusBar label="Approved" count={analytics.approved} total={analytics.total} color="bg-green-500" />
                    <StatusBar label="Rejected" count={analytics.rejected} total={analytics.total} color="bg-red-500" />
                    <StatusBar label="Pending" count={analytics.pending} total={analytics.total} color="bg-yellow-500" />
                    <StatusBar label="Draft" count={analytics.draft} total={analytics.total} color="bg-gray-400" />
                  </div>
                </CardContent>
              </Card>
